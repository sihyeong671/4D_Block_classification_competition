...
browser = webdriver.Chrome("/usr/local/bin/chormedriver", options=options)
...
for keyword in keywords:
    ...
    test = browser.find_element(By.CLASS_NAME, "add_search_params pure-form")
    print(test)
    break
    for page in tqdm(range(1, pages+1)):
        ...
        for img in imgs:
            ...
            if len(srcset):
                ...
                saveUrl = os.path.join(DATA_PATH, filename) #저장 경로 결정
